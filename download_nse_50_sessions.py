...
if len(dates)<50:
    raise SystemExit(f'Need 50 raw sessions, found {len(dates)}')
...
# Official NSE India VIX is present in the official NSE index-close archive.
# This avoids the fragile historical/vixhistory API and does not fabricate values.
vrows=[]
for d in dates:
    p=f'{INDEX}/{d}.csv'
    try:
...
if vrows:
    ...
    print('WARNING: Official NSE India VIX unavailable; VIX remains N/V rather than fabricated.')
