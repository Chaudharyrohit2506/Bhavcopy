import json,html,os
D=json.load(open('data/market_intelligence.json',encoding='utf8')); rows=D['sessions']; latest=rows[-1]; dates=[r['session_date'] for r in rows]
...
'__NET__':f'{latest["advances"]-latest["declines"]:+,}','__ADR__':n(latest['ad_ratio']),'__TRIN__':n(latest['trin']),
